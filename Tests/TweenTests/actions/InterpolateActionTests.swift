...
class InterpolateActionTests: XCTestCase {
    ...
    func testInterpolateActionEndsWithStartValueReversed() {
        ...
        var value = 0.0
        let action = InterpolationAction(from: 0.0, to: 1.0, duration: duration, easing: .linear) {
            value = $0
        }
        action.reverse = true
    ...
    func testInterpolateActionFullLifeCycleResultsInExpectedEndValue() {
        ...
        var value = 0.0
        let action = InterpolationAction(from: 0.0, to: 1.0, duration: 5.0, easing: .linear) {
            value = $0
        }
